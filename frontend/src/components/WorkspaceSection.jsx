  ...
  return (
    <section className="space-y-4 sm:space-y-6">
      <div className="rounded-2xl border border-slate-200 bg-white p-4 sm:p-6">
        ...
        <p className="text-sm text-slate-600">{tr(lang, '\u0623\u0636\u0641 \u0631\u0627\u0628\u0637 \u064a\u0648\u062a\u064a\u0648\u0628 \u0623\u0648 \u0646\u0635\u064b\u0627 \u0645\u0643\u062a\u0648\u0628\u064b\u0627\u060c \u062b\u0645 \u062d\u0648\u0651\u0644 \u0627\u0644\u0645\u062d\u062a\u0648\u0649 \u0625\u0644\u0649 \u062e\u0637\u0648\u0627\u062a \u0642\u0627\u0628\u0644\u0629 \u0644\u0644\u062a\u0637\u0628\u064a\u0642 \u0623\u0648 \u0627\u0633\u0623\u0644 \u0627\u0644\u0645\u0633\u0627\u0639\u062f \u0627\u0644\u0630\u0643\u064a.', 'Add a YouTube URL or written text, then generate an actionable output or chat.', 'Ajoutez un lien YouTube ou un texte ecrit, puis generez une sortie exploitable ou utilisez le chat.')}</p>
      </div>
      {accountRestrictionMessage ? (
