...
function RefundPolicyPage({ lang = LANG.ar, theme = 'light' }) {
  const structuredData = {
    ...
    '@type': 'WebPage',
    name: 'Refund Policy | Transcripta AI',
    url: `${SEO_CONFIG.SITE_ORIGIN}/refund-policy`,
    description: 'Refund policy for Transcripta AI digital transcript generation service.'
  };
  return (
    <>
      <SeoMeta
